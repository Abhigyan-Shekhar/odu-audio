...
class DegradationManager:
    ...
    def should_degrade(self) -> bool:
        ...
        next_level = DegradationLevel(self.current_level + 1)
    ...
    def degrade(self) -> Optional[DegradationLevel]:
        ...
        self.current_level = DegradationLevel(
            min(self.current_level + 1, DegradationLevel.LEVEL_5)
        )
        self.last_level_change_time = time.time()
    ...
    def recover(self) -> Optional[DegradationLevel]:
        ...
        old_level = self.current_level
        self.current_level = DegradationLevel(
            max(self.current_level - 1, DegradationLevel.LEVEL_0)
        )
        self.last_level_change_time = time.time()
    ...
    def get_status_summary(self) -> dict:
        ...
        return {
            ...
            "active_components": {
                ...
                "diarization_refinement": self.is_component_active(
