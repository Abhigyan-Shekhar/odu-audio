...
class AcousticFeatureRecord:
    ...
    def __post_init__(self):
        ...
        valid_statuses = {"PATIENT", "NON_PATIENT", "UNKNOWN", "OVERLAP", "LOW_CONFIDENCE"}
        ...
        valid_quality = {"OK", "CLIPPED", "LOW_SNR", "DROPOUT", "REJECTED", 
                        "INSUFFICIENT_AUDIO", "UNKNOWN"}
    ...
    def is_patient_speech(self, threshold: float = 0.5) -> bool:
        ...
        """
        return (
            self.attribution_status == "PATIENT" and
            self.patient_probability is not None and
            self.patient_probability >= threshold
        )
    ...
    def is_usable(self, min_patient_prob: float = 0.5) -> bool:
        ...
        """
        return (
            not self.has_quality_issues() and
            self.is_patient_speech(threshold=min_patient_prob) and
            self.egemaps is not None  # Has acoustic features
        )
